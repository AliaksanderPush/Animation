    ...
    function loaded(error, countries, airports) {
        ...
        let geos = topojson.feature(airports, airports.objects.airports).features;
        for (let i in geos) {
    ...
    let queue = d3.queue();
        queue.defer(d3.json, "./json/countries1.json")
            .defer(d3.json, "./json/airports1.json")
            .await(loaded);    
